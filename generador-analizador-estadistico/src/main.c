...
int main(int argc, char *argv[]) {
    ...
    if (argc > 1) {
        ...
        if (argc != 6 && argc != 7) {
            ...
            printf("\nEjemplos:\n");
            printf("  ./proyecto uniforme 1000 -1 1 42\n");
            printf("  ./proyecto normal   2000 -5 5 42\n");
            printf("  ./proyecto normal   2000 params 0 1.0 42\n");
            printf("  ./proyecto laplace  1000 params 0 0.5 42\n");
            return 1;
        }
...
void menuPrincipal() {
    ...
    printf("=============================================\n");
    printf("  ANALIZADOR ESTADISTICO  -  PROYECTO\n");
    printf("=============================================\n");
